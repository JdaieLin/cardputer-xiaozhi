...
ssh "$REMOTE" "cp '$REMOTE_DIR/build/xiaozhi-applaunch_0.1-m5stack1_arm64.deb' '$REMOTE_TMP' && echo pi | sudo -S dpkg -i '$REMOTE_TMP' && echo pi | sudo -S systemctl restart APPLaunch.service"
